...
default:
	...
	@echo "2. make app-delete-domain name=YourBusinessDomain (deletes a DDD directory structure)"
	@echo "3. make app-code-fix (applies coding standards to the application)"
	@echo "3. more command are currently in development"
	@echo ""
	@echo ""
	@echo ""
